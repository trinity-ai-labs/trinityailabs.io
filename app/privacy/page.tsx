        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-invert prose-sm max-w-none space-y-8 text-muted-foreground [&_h2]:text-foreground [&_h3]:text-foreground [&_strong]:text-foreground">
            <section>
              ...
              <p>
                Trinity AI Labs (&quot;we&quot;, &quot;us&quot;,
                &quot;our&quot;) operates the Trinity desktop application and
                the trinityailabs.com website (collectively, the
            ...
            <section>
              ...
              <p>
                ...
                and password (hashed). If you sign up via Google or GitHub
                OAuth, we receive your name, email, and profile picture from
                those providers. We do not receive or store your OAuth
                passwords.
              </p>
              ...
              <p>
                ...
                project execution. These are encrypted at rest using a
                per-database 256-bit encryption key. Encryption keys are
                delivered to your desktop app over HTTPS. We do not access or
                use your stored secrets for any purpose other than delivering
                them to your authenticated devices.
              </p>
              ...
              <p>
                ...
                indicators. We also collect a device name (e.g.,
                &quot;Alex&apos;s MacBook&quot;) for display purposes.
              </p>
              ...
              <p>
                ...
                (wireframes, PDFs, fonts, images) are stored on Cloudflare R2.
                File metadata syncs across your devices via Turso. If you use
              ...
              <p>
                Certain data never leaves your machine: filesystem paths,
                worktree locations, local process IDs, port allocations, and
                machine-specific settings. This data is stored in a local SQLite
                database on your device and is never transmitted to our servers.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1.5">
                <li>
                  ...
                  your project data across devices, enable team collaboration,
                  and run the execution pipeline.
                </li>
                <li>
                ...
                <li>
                  ...
                  verification, team invitations, and password resets via
                  Resend.
                </li>
                <li>
                  <strong>Display metrics</strong> — show execution analytics,
                  cost tracking, and team activity within the app.
                </li>
                <li>
                  <strong>Maintain security</strong> — detect unauthorized
                  access, manage device authentication tokens, and enforce
                  subscription status.
                </li>
              </ul>
              <p className="mt-3">
                We do not sell your personal information. We do not use your
                project data or code to train AI models. We do not serve
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1.5">
                <li>
                  <strong>Turso</strong> — cloud database hosting for account
                  data and synced project databases.
                </li>
                <li>
                  <strong>Lemon Squeezy</strong> — payment processing,
                  subscription management, tax/VAT compliance (Merchant of
                  Record).
                </li>
                <li>
                ...
                <li>
                  ...
                  providers (only if you choose to sign in with these).
                </li>
              </ul>
              <p className="mt-3">
                Each service processes data in accordance with their own privacy
                policies. We share only the minimum data necessary for each
                service to function.
              </p>
            </section>

            <section>
              <h2 className="text-xl font-semibold">5. AI &amp; Claude Code</h2>
              <p>
                Trinity orchestrates Claude Code (by Anthropic) as a subprocess
                on your local machine. Trinity does not proxy AI requests —
                Claude Code connects directly to Anthropic using your own Claude
                subscription or API key. Your code and prompts are sent from
                your device to Anthropic, not through our servers.
                Anthropic&apos;s privacy policy governs their handling of that
                data.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1.5">
                ...
                <li>Website sessions use secure, HTTP-only cookies.</li>
                <li>
                  Each team gets a physically isolated database — your
                  team&apos;s data is not co-mingled with other teams.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                your subscription lapses, your data is preserved (read-only
                access) and is never deleted. Reactivating your subscription
                restores full access. If you request account deletion, we will
                delete your account data, personal sync database, and any team
                databases you own (after notifying team members). Deleted team
                databases are held for 30 days before permanent deletion.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                cached in the team&apos;s database so team members can see who
                they are collaborating with, including offline. Activity feeds,
                comments, and execution status are visible to all team members.
                If you are removed from a team, your Turso access token is
                revoked and you can no longer access the team&apos;s data.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                notify you of material changes by email or via a notice in the
