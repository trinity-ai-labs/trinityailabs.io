          ...
          <div className="prose prose-invert prose-sm max-w-none space-y-8 text-muted-foreground [&_h2]:text-foreground [&_h3]:text-foreground [&_strong]:text-foreground">
            <section>
              ...
              <p>
                ...
                Trinity desktop application and trinityailabs.com website
                (collectively, the &quot;Service&quot;) operated by Trinity AI Labs
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1.5">
                <li>
                  The Trinity desktop application (macOS, Linux).
                </li>
                <li>
            ...
            <section>
              ...
              <p>
                ...
                for maintaining the security of your account credentials. You must
                provide accurate information and keep it up to date. You must be at
                least 16 years old to create an account. One account per person —
            ...
            <section>
              ...
              <p>
                The Service is offered at <strong>$10 per seat per month</strong>.
                Every subscription includes the full feature set — there are no
                feature tiers or gated capabilities. Pricing may change with
                reasonable notice.
              </p>
              ...
              <p>
                ...
                Lemon Squeezy handles billing, invoicing, tax/VAT calculation, and
                refunds. By subscribing, you also agree to Lemon Squeezy&apos;s
                terms of service.
              </p>

              <h3 className="text-lg font-medium mt-4">4.3 Team Seats</h3>
              <p>
                Team owners may purchase additional seats for team members at $10
                per seat per month. Team-paid members receive full access covered
                by the owner&apos;s subscription. Members may also bring their own
                subscription. A person never needs more than one subscription.
              </p>
              ...
              <p>
                If your subscription becomes inactive, you retain read-only access
                to your data. Execution and writes are blocked. Cloud sync is
                paused. Your data is never deleted due to subscription lapse —
                reactivating restores full access. For team-paid members, if the
                team owner&apos;s subscription lapses, all team-paid seats lose
                write access. Self-paid members on the same team are unaffected.
              </p>
            ...
            <section>
              ...
              <p>
                ...
                machine, along with a valid Claude subscription or Anthropic API
                key. Trinity does not provide AI compute — it orchestrates Claude
                Code as a local subprocess. You are responsible for your own Claude
                subscription and any associated costs. Your use of Claude Code is
                governed by Anthropic&apos;s terms of service and acceptable use
                policy.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                Per-user limit: 5GB. Allowed types: images, PDFs, fonts, documents,
                SVGs. We reserve the right to remove content that violates these
                limits or our acceptable use policy.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                removed member will fail. The removed member can no longer access
                the team&apos;s data.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1.5">
                <li>
                  Use the Service to generate malicious software, malware, or code
                ...
                <li>
                  Circumvent subscription checks, offline grace periods, or other
                  access controls.
                </li>
                <li>
                  Store illegal content in Trinity-managed asset storage.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                While Trinity orchestrates quality checks and review pipelines, we
                do not guarantee that generated code is free of bugs, security
                vulnerabilities, or errors. You are responsible for reviewing,
                testing, and validating all code before deploying it to production.
              </p>
              ...
              <p>
                ...
                uptime. The desktop app works offline with local data — cloud sync
                requires an internet connection. We are not liable for
                interruptions caused by Turso, Lemon Squeezy, Anthropic, or other
            ...
            <section>
              ...
              <p>
                ...
                account if you violate these Terms. Upon termination, your data is
                preserved for 30 days (read-only) before permanent deletion, unless
            ...
            <section>
              ...
              <p>
                ...
                use after changes take effect constitutes acceptance. If you
                disagree with updated Terms, you may cancel your subscription.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                negotiation first. If negotiation fails, disputes will be resolved
