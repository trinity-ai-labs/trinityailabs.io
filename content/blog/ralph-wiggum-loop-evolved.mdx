...
It worked. Huntley built CURSED — a full programming language — using nothing but the loop. Others followed. An engineer delivered a $50K contract MVP for $297 in API costs. The technique spawned dozens of open-source tools: ralphy, ralph-orchestrator, open-ralph-wiggum, smart-ralph. The community exploded.
...
- **Quality checkpoint approval** before code merges
...
<ComparisonTable
  ...
  rows={[
    ["Supervision", "Runs unsupervised", "Full auto, gated, or manual"],
...
![Three oversight modes — Full Auto, Gated, and Manual — with five gate types for different checkpoints.](/blog/inline/ralph-wiggum-gates.png)
...
Multiple PRDs feeding into coordinated releases. Four specialized agents instead of one generalist looping. Configurable quality gates instead of unsupervised execution. Parallel workers instead of sequential tasks. Compound knowledge instead of amnesia.
